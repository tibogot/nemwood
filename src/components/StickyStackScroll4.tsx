        ...
        <div className="space-y-8 px-4">
          ...
          <div className="bg-secondary border-primary/30 overflow-hidden border-t py-6">
            ...
            <p className="font-HelveticaNow text-lg leading-relaxed">
              Chez Nemwood, la durabilité est au cœur de notre démarche. Chaque
              projet est conçu dans le respect de l'environnement, en
              privilégiant des matériaux issus de filières responsables et une
              gestion raisonnée des ressources. <br /> Nous travaillons
              exclusivement avec des essences de bois certifiées et des
              partenaires locaux pour limiter notre empreinte carbone et
          ...
          <div className="bg-secondary border-primary/30 overflow-hidden border-t py-6">
            ...
            <p className="font-HelveticaNow text-lg leading-relaxed">
              Le choix des matériaux est au fondement de notre métier. Chaque
              projet prend vie à partir de bois sélectionnés pour leur qualité,
              leur traçabilité et leur faible impact environnemental. En
              privilégiant des essences durables et certifiées, nous
              garantissons la longévité de nos créations. <br /> Notre approche
              repose sur une utilisation raisonnée des ressources : optimiser
              chaque pièce, limiter les pertes et valoriser les chutes. <br />{" "}
              Ce souci du détail permet de créer des réalisations solides,
              élégantes et pensées pour durer. Choisir Nemwood, c'est opter pour
              une fabrication où performance, esthétique et responsabilité ne
              font qu'un.
            </p>
            <div className="mt-8">
              <div className="h-[400px] w-full overflow-hidden rounded-sm">
          ...
          <div className="bg-secondary border-primary/30 overflow-hidden border-t py-6">
            ...
            <p className="font-HelveticaNow text-lg leading-relaxed">
              Chaque projet est unique, c'est pourquoi nous concevons et
              fabriquons des pièces entièrement sur mesure, adaptées à vos
              besoins et votre espace. <br /> Du mobilier aux rangements, notre
              savoir-faire permet de créer des aménagements précis et
              esthétiques. <br /> En alliant méthodes modernes et exécution
              artisanale, nous garantissons des finitions soignées et une
              durabilité dans le temps. <br /> Chaque élément répond précisément
              à vos attentes.
            </p>
            <div className="mt-8">
              <div className="h-[400px] w-full overflow-hidden rounded-sm">
          ...
          <div className="bg-secondary border-primary/30 overflow-hidden border-t py-6">
            ...
            <div className="mt-8" />
            <p className="font-HelveticaNow text-lg leading-relaxed">
              Avant chaque fabrication, nous donnons vie à vos idées grâce à la
              modélisation 3D. Cet outil permet de visualiser le projet dans ses
              moindres détails et d'ajuster proportions, matériaux ou
              fonctionnalités pour une intégration parfaite. La 3D offre une
              projection réaliste du rendu final : volumes, couleurs,
              éclairages... Cette étape essentielle garantit une compréhension
              claire et évite les mauvaises surprises. Vous validez votre
