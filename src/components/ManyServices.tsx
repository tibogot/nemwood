    ...
    >
      <a href={href} className="relative z-10 block">
        ...
        <div className="relative z-10 flex items-center justify-between px-2 py-3 md:px-4 md:py-4">
          <span className="text-primary text-sm font-light transition-colors duration-500 group-hover:text-white md:text-lg lg:text-xl">
            {String(index + 1).padStart(2, "0")}
          </span>
          <h3 className="text-primary text-3xl transition-all duration-500 group-hover:translate-x-2 group-hover:text-white md:text-6xl lg:text-8xl">
            {name}
          </h3>
          <span className="text-primary text-xs font-light transition-colors duration-500 group-hover:text-white md:text-sm lg:text-base">
            En savoir plus →
          </span>
