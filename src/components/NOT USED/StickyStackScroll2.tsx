...
function Card1() {
  return (
    <div className="card relative w-full" id="card-1">
      <div className="card-inner bg-secondary text-primary border-primary/30 h-[600px] w-full overflow-hidden border-t p-6 md:h-[600px] md:p-10">
        <div className="flex h-full w-full flex-col md:flex-row">
          {/* LEFT */}
          <div className="flex h-full w-full flex-col md:w-1/2 md:pr-6">
            {/* Text */}
            <div>
    ...
    <div className="card relative w-full" id="card-3">
      <div className="card-inner bg-secondary text-primary border-primary/30 h-[600px] w-full overflow-hidden border-t p-6 md:h-[600px] md:p-10">
        <div className="flex h-full w-full flex-col md:flex-row">
          ...
          <div className="right relative hidden h-full w-full overflow-hidden rounded-sm md:flex md:w-1/2">
            <Image
              src="/images/wardrobe.webp"
              alt="Garde-robes sur mesure"
              fill
