    ...
    <>
      ...
      <div className="wrapper bg-secondary text-primary">
        ...
        <section className="flex w-full flex-col items-center justify-center px-4 pt-40 md:px-8">
          <ParallaxImage
            speed={0.5}
            className="h-[400px] w-full md:h-[600px] md:w-[400px]"
          >
            <Image
        ...
        <section className="text-primary bg-secondary intro mx-auto px-4 py-20 text-center md:px-8 md:py-20">
          <AnimatedText delay={0.0} stagger={0.3}>
            ...
            <p className="font-HelveticaNow mx-auto max-w-2xl text-lg">
              Vous cherchez un artisan menuisier en Belgique pour créer des
              meubles en bois sur mesure ? Nemwood vous accompagne à chaque
              étape de votre projet, de la conception à la réalisation, pour
              donner vie à un aménagement qui vous ressemble.
            </p>
          </AnimatedText>
        </section>
      </div>
