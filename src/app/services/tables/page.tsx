                  ...
                  <div className="flex w-full min-w-0 flex-col md:max-w-xl md:flex-1">
                    ...
                    <AnimatedText>
                      <p className="font-HelveticaNow pt-8 text-lg">
                        ...
                        vie, le nombre de convives et vos préférences
                        esthétiques. Que ce soit une table à manger pour
                        rassembler toute la famille, une table basse pour votre
                        salon, ou un bureau sur mesure pour votre espace de
                        travail, nous adaptons chaque dimension, chaque forme,
                        chaque détail à votre vision. Le résultat est une table
                        unique qui s'intègre parfaitement dans votre intérieur
                        et répond exactement à vos attentes.
                      </p>
                    </AnimatedText>
                  </div>
                </div>
                ...
                <div className="flex w-full min-w-0 flex-col md:max-w-xl md:flex-1">
                  <AnimatedText>
                    <p className="font-HelveticaNow text-lg">
                      Nous travaillons avec les plus belles essences de bois :
                      chêne pour sa robustesse et ses veines marquées, noyer
                      pour son élégance et sa chaleur, frêne pour sa légèreté et
                      sa finesse. Chaque essence est sélectionnée pour ses
                      qualités spécifiques et sa capacité à s'embellir avec le
                      temps.
                    </p>
                  </AnimatedText>
                </div>
            ...
            <div className="mx-auto flex max-w-3xl flex-col items-center">
              ...
              <AnimatedText>
                <p className="font-HelveticaNow mt-10 w-full text-left text-lg md:mt-16">
                  ...
                  expertise. Nos menuisiers maîtrisent les techniques
                  ancestrales du travail du bois : sélection des planches,
                  assemblage à tenons et mortaises, ponçage méticuleux. Nous
                  privilégions le bois massif pour sa solidité exceptionnelle et
                  sa capacité à résister aux épreuves du temps. Les pieds sont
                  conçus pour supporter le poids de la table, les assemblages
                  sont renforcés pour garantir une stabilité parfaite, même pour
                  les plus grandes dimensions. Chaque geste compte, chaque
                  détail est soigné.
                </p>
              </AnimatedText>
            </div>
                  ...
                  <div className="flex w-full min-w-0 flex-col md:max-w-xl md:flex-1">
                    ...
                    <AnimatedText>
                      <p className="font-HelveticaNow pt-8 text-lg">
                        ...
                        commençons par une visite à domicile pour comprendre
                        votre espace, vos besoins et votre style. Nous réalisons
                        ensuite un plan détaillé avec plusieurs propositions de
                        design. Une fois votre choix arrêté, nous vous
                        fournissons un devis transparent et un planning précis.
                        Tout au long de la fabrication, nous vous tenons informé
                        de l'avancement. L'installation est réalisée par nos
                        équipes qui veillent à chaque détail pour que votre
                        table trouve parfaitement sa place dans votre intérieur.
                        Un meuble sur mesure, c'est aussi un service sur mesure.
                      </p>
                    </AnimatedText>
                  </div>
                </div>
