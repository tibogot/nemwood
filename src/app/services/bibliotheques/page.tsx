...
import { bibliothequesFaqs } from "@/data/faqs";
...
export const metadata: Metadata = generateMetadata(
  ...
  "/images/og/og-bibliotheques.webp",
  "https://www.nemwood.be/services/bibliotheques",
  undefined,
  "Bibliothèque en bois sur mesure - Nemwood",
);
...
export default function BibliothequePage() {
  return (
    <>
      ...
      <FAQSchema faqs={bibliothequesFaqs} />
      <FAQ
