        ...
        <section className="text-primary border-primary mx-auto border-y px-4 py-20 text-center md:px-8 md:py-40">
          <AnimatedText>
            <p className="font-HelveticaNow mx-auto text-lg md:max-w-2xl">
              ...
              productivité, façonnés à la main en Belgique pour créer un espace
              de travail qui inspire et respire.
            </p>
          </AnimatedText>
        </section>
                  ...
                  <div className="flex w-full min-w-0 flex-col md:max-w-xl md:flex-1">
                    ...
                    <AnimatedText>
                      <p className="font-HelveticaNow pt-8 text-lg">
                        Un bureau sur mesure, c'est d'abord un bureau qui
                        respecte votre corps et vos habitudes de travail. Nous
                        concevons chaque bureau selon des principes ergonomiques
                        : hauteur adaptée à votre taille, profondeur optimale
                        pour vos écrans, espace pour vos jambes, support pour
                        vos avant-bras. Nous adaptons aussi la largeur et la
                        forme selon votre activité : bureau droit pour un
                        travail concentré, bureau d'angle pour maximiser
                        l'espace, ou bureau avec retour pour créer des zones de
                        travail distinctes. Chaque dimension est calculée pour
                        réduire la fatigue et améliorer votre confort quotidien.
                      </p>
                    </AnimatedText>
                  </div>
                </div>
              ...
              <div className="left md:order-2">
                <div className="flex flex-col items-start gap-6 md:flex-row md:gap-8">
                  ...
                  <div className="flex w-full min-w-0 flex-col md:max-w-xl md:flex-1">
                    ...
                    <AnimatedText>
                      <p className="font-HelveticaNow pt-8 text-lg">
                        Un bureau organisé est un bureau efficace. Nous
                        intégrons des solutions de rangement sur mesure :
                        tiroirs pour vos documents et accessoires, casiers pour
                        vos classeurs, étagères pour vos références, niches pour
                        vos équipements. Nous prévoyons aussi des passages de
                        câbles discrets et des prises intégrées pour un espace
                        de travail propre, sans fils qui traînent. Chaque
                        rangement est pensé pour être accessible en un geste,
                        optimisant vos mouvements et votre productivité. Rien
                        n'est laissé au hasard pour créer un environnement de
                        travail parfaitement organisé.
                      </p>
                    </AnimatedText>
                  </div>
                </div>
            ...
            <div className="mb-10 md:mb-16 md:w-1/2">
              <AnimatedText>
                <p className="font-HelveticaNow text-lg">
                  Nous travaillons avec des essences de bois adaptées aux
                  espaces de travail : chêne pour sa robustesse, noyer pour son
                  élégance, frêne pour sa légèreté. Chaque essence est
                  sélectionnée pour ses qualités et sa capacité à créer une
                  atmosphère de travail inspirante.
                </p>
              </AnimatedText>
            </div>
                  ...
                  <div className="flex w-full min-w-0 flex-col md:max-w-xl md:flex-1">
                    ...
                    <AnimatedText>
                      <p className="font-HelveticaNow pt-8 text-lg">
                        ...
                        tout en conservant sa beauté. Nous proposons des
                        finitions spécifiques aux espaces de travail : huiles
                        dures pour une protection maximale contre les taches et
                        les rayures, vernis mat pour éviter les reflets sur les
                        écrans, finitions antimicrobiennes pour un espace de
                        travail sain. Chaque finition est appliquée en plusieurs
                        couches, poncée méticuleusement, pour obtenir une
                        surface parfaitement lisse et résistante. Nous prêtons
                        une attention particulière aux angles et aux bords,
                        zones les plus exposées. Le résultat est un bureau qui
                        conserve son aspect neuf même après des années
